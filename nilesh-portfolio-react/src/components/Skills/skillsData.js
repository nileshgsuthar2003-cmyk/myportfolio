export const skillsData = [
  {
    ...
    content: "Designing scalable server architectures, robust REST APIs, and enterprise backend systems. Extensive experience with Node.js, Express, Python, Django, Java, and Spring Boot for high-performance applications.",
    pills: ["Node.js", "Express", "Python", "Django", "Java", "Spring Boot"],
