export const skillsData = [
  {
    ...
    content: "Designing scalable server architectures, robust REST APIs, and enterprise backend systems. Extensive experience with Node.js, Python, Django, and Flask for high-performance applications.",
    pills: ["Node.js", "Python", "Django", "Flask"],
